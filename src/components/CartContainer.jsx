...
import img1 from '../img/f10.png';

const CartContainer = () => {
  return (
    <div className='fixed z-[101] top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col'>
        ...
        <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
            ...
            <div className='w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none'>
                ...
                <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2'>
                    <img src={img1} alt={'item-img'} className="w-20 h-20 max-w-[60px] rounded-full object-contain" />

                    {/* name section */}
                    <div className='flex flex-col gap-2'>
                        <p className='text-base text-gray-50'>Chocolate vanilla</p>
                        <p className='text-sm block text-gray-300 font-semibold'>$.85</p>
                    </div>
